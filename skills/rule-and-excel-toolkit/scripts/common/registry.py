...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("excel", "split", "excel_split_by_deviceaddress.py", "按字段值拆分多 Sheet", output_suffix="_拆分", options=(O("--log-column", kwargs={"default": "原始日志"}), O("--fields", kwargs={"default": "deviceName,productVendorName,deviceSendProductName,dvcAddress,rawEvent,deviceAddress,dataType"}), O("--split-field", kwargs={"default": "deviceAddress"}), O("--keep-columns"), O("--no-full-sheet", kwargs={"action": "store_true"}))),
