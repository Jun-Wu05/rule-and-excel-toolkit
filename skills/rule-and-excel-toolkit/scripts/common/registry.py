...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("rule", "clone-rule", "rule_clone_rule.py", "克隆指定子规则 N 份", supports_verify=True, output_suffix="_规则复制", options=(O("--rule-id", kwargs={"required": True}), O("--count", kwargs={"type": int, "required": True}), O("--suffix", kwargs={"default": "_copy"})),),
